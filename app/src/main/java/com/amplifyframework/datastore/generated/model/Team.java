...
public final class Team implements Model, Parcelable {
  ...
  private final @ModelField(targetType="Task") @HasMany(associatedWith = "teamListOfTasksId", type = Task.class) List<Task> listOfTasks = null;
